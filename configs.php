...
$TABLE["Events"] 	= $sql_prefix.'_events';
...
if ($installed!='yes') {	
	$connEV = mysqli_connect($CONFIG["hostname"], $CONFIG["mysql_user"], $CONFIG["mysql_password"], $CONFIG["mysql_database"]);
	if (mysqli_connect_errno()) {
		die('MySQL connection error: .'.mysqli_connect_error());
	}
	mysqli_set_charset($connEV, "utf8");
}
